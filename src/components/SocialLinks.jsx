...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/samir-sain-8774b936b/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@codexmir",
    icon: Instagram,
    url: "https://www.instagram.com/codexmir/",
    color: "#E4405F",
  ...
  },
  {
    ...
    subText: "@SAMIRSAIN",
    icon: Github,
    url: "https://github.com/Samirsain",
    color: "#ffffff",
  ...
  },
  {
    ...
    url: "https://www.tiktok.com/@samir_sain",
    color: "black",
