        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
  I'm passionate about crafting beautiful and user-friendly digital experiences. Currently pursuing a Bachelor's in Computer Applications (BCA), I actively explore the latest trends in frontend development and UI design. I enjoy turning ideas into interactive web solutions, and I’m always learning and experimenting — from coding interfaces to exploring the power of AI. With a strong desire to grow and create impact through technology, I believe consistency and creativity go hand in hand. </p>
      ...
      >
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leverages tech & AI, BCA background, passion for frontend/UI."
        </blockquote>
      </div>

            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="https://drive.google.com/file/d/1-1J60JjFsyOgGCChJA_ZMq9JYXwYPk3E/view?usp=sharing" className="w-full lg:w-auto">
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
