...
const WORDS = ["Frontend Developer", "Tech Enthusiast", "UI/UX Designer", "React Developer"];

const TECH_STACK = ["React", "Javascript", "Node.js", "Tailwind"];
const SOCIAL_LINKS = [
  { icon: Github, link: "https://github.com/Samirsain" },
  { icon: Linkedin, link: "https://www.linkedin.com/in/samir-sain-8774b936b/" },
  { icon: Instagram, link: "https://www.instagram.com/codexmir/" }
];
            ...
            <div className="w-full lg:w-1/2 space-y-6 sm:space-y-8 text-left lg:text-left order-1 lg:order-1 lg:mt-0" data-aos="fade-right" data-aos-delay="200">
              <div className="space-y-4 sm:space-y-6">
                ...
                <p className="text-base md:text-lg text-gray-400 max-w-xl leading-relaxed font-light" data-aos="fade-up" data-aos-delay="1000">
                  Turning ideas into beautiful, interactive, and responsive websites that deliver a seamless user experience.
                </p>
