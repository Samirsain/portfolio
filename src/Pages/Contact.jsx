...
const ContactPage = () => {
  ...
  // Import Supabase client at the top of your file:
  ...
  return (
    <div className="px-[5%] sm:px-[5%] lg:px-[10%]">
      <div className="text-center lg:mt-[5%] mt-10 mb-2 sm:px-0 px-[5%]">
        ...
        >
          Got a question or idea? I’m just a message away — happy to connect!
        </p>
      </div>
            ...
            <div className="flex justify-between items-start mb-8">
              <div>
                ...
                <p className="text-gray-400">
                  Have something to discuss? Drop me a message and let’s build something awesome together.
                </p>
              </div>
